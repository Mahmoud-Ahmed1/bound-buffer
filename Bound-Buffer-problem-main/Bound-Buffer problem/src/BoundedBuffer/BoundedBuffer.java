...
public class BoundedBuffer {
    ...
    public void placeOrder(String item){
        ...
        if (Count==10){
            ...
            In=(In+1)%bufferSize;
            Count++;
            System.out.println(Thread.currentThread().getName()  + " produc the Counter is "+Count+"");
         ...
         String item = "Noting";       
            if ( Count==0 ) {
             ...
             try {
                ...
                System.out.println(Thread.currentThread().getName()+  " is consum counter is " +  Count + "");
